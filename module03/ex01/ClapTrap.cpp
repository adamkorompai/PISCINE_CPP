...
/*   Updated: 2023/07/18 14:44:41 by akorompa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap()
{
	std::cout << "\033[34m" << "ClapTrap destructor for " << "\033[0m" << this->_name << " called.\n";
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hit_pts(10), _energy_pts(10), _attack_pts(0)
{
	std::cout <<  "\033[34m" <<"ClapTrap constructor with name (" << name << ") assignment called.\n" << "\033[0m";
}
